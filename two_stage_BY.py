...
axs[0].plot(time1[:i+1], test1[:i+1], '.', color='purple', markersize=5, label = 'Real Data')
axs[0].plot(time1[:i+1], linear_regression[:], '-', color='cyan', linewidth=2, label='Linear Prediction')
axs[0].plot(time1[i:], test1[i:], '.', color='purple', markersize=5)
axs[0].plot(time1, 0.3*np.ones_like(time1), '--')
...
axs[1].plot(time2[:i+1], test2[:i+1], '.', color='purple',markersize=5, label = 'Linear Real')
axs[1].plot(time2[:i+1], linear_regression, 'c-', linewidth = 2, label = 'Linear Predict')
axs[1].plot(time2[i:], test2[i:], '.', color='purple',markersize=5, label = 'Exponential Real')
axs[1].plot(time2, 0.3*np.ones_like(time2), '--')
...
new_t2 = np.linspace(0, (N2+10)/6, N2+15)
...
axs[2].plot(time3[:i+1], test3[:i+1], '.', color='purple',markersize=5, label = 'Linear Real')
axs[2].plot(time3[:i+1], linear_regression, 'c-', linewidth = 2, label = 'Linear Predict')
axs[2].plot(time3[i:], test3[i:], '.', color='purple',markersize=5, label = 'Exponential Real')
axs[2].plot(time3, 0.3*np.ones_like(time3), '--')
